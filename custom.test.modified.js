...
describe('Custom Tests', function () {
  ...
  it('[assignment] ii. deposit 0.1 ETH in L1 -> withdraw 0.08 ETH in L2 -> assert balances', async () => {
    ...
    //doesn't matter who the recipent is that we withdraw too
    // we can assume it is some address Alice or her friend controls
  ...
  it('[assignment] iii. see assignment doc for details', async () => {
    ...
    const bobEthAddress = '0xda9dfa130df4de4673b89022ee50ff26f6ea73cf'
    ...
    // withdraws remaining funds from the shielded pool
    ...
    const AliceRecipientBalance = await token.balanceOf(aliceEthAddress)
